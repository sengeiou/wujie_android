...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public EaseMessageAdapter(Context context, String username, int chatType, String myHead, String userHead,
                              ListView listView) {
        ...
        this.myHead = myHead;
        this.conversation = EMClient.getInstance().chatManager().getConversation(username, EaseCommonUtils
    ...
    protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        switch (message.getType()) {
            case TXT:// 文本
                if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    chatRow = new EaseChatRowBigExpression(context, message, position, this, myHead, userHead);
                } else {
                    chatRow = new EaseChatRowText(context, message, position, this, myHead, userHead);
                }
                break;
            case LOCATION:// 位置
            ...
            case FILE:// 文件
                ...
                break;
            case IMAGE:// 图片
                chatRow = new EaseChatRowImage(context, message, position, this, myHead, userHead);
                break;
            case VOICE:// 语音
                chatRow = new EaseChatRowVoice(context, message, position, this, myHead, userHead);
                break;
            case VIDEO:// 视频
