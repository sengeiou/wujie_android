...
import com.txd.hzj.wjlp.huanxin.domain.InviteMessage;
import com.txd.hzj.wjlp.huanxin.domain.RobotUser;
import com.txd.hzj.wjlp.huanxin.parse.UserProfileManager;
...
//                            intent.putExtra("userHead", data.get("head_pic"));// 对方头像
//                            intent.putExtra("userName", data.get("nickname"));// 对方昵称
//
//                        }
//
//                        @Override
