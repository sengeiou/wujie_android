...
public class VScrollScreenLayout extends ViewGroup {
    ...
    public static boolean TOUCH_BOOLEAN = true;
    private boolean isSlidable = true; // 是否可滑动
     ...
     * @param isSlidable
     */
    public void setIsSlidable(boolean isSlidable) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (getChildCount() == 0 || !isSlidable) // 如果子项目数量为0或者不可滑动，则直接返回
