...
public class OfflineStore {
     ...
     */
    public static void offlineStoreList(String lng, String lat, int p, String merchant_id, String top_cate, String little_cate, BaseView baseView) {
        ApiTool2 apiTool2 = new ApiTool2();
        ...
        requestParams.addBodyParameter("little_cate", little_cate);
     ...
     * @param merchant_id
     */
    public static void order_print(String order_sn, String merchant_id, BaseView baseView) {
        ApiTool2 apiTool2 = new ApiTool2();
        RequestParams requestParams = new RequestParams();
        requestParams.addBodyParameter("order_sn", order_sn);
        requestParams.addBodyParameter("merchant_id", merchant_id);
        apiTool2.postApi(url + "order_print", requestParams, baseView);
    }
}
