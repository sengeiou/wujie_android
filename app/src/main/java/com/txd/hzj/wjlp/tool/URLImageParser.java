 ...
 * 创建时间：2018/6/21 10:14
 * 功能描述：  https://blog.csdn.net/dhyjtt/article/details/53706820
...
public class URLImageParser implements Html.ImageGetter {
    ...
    public URLImageParser(Context context, TextView tvContent) {
        ...
        actX = metrics.widthPixels - DensityUtil.dip2px(DemoApplication.getInstance().getApplicationContext(), 40);
