...
public class CatcherAddressAty extends BaseAty {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.default_address_layout:
                Catcher.goodsOrder(mCid,mGoods_id,defaultAddress_id,mProduct_id,mCatcher_num,this);
                break;
        }
    }
    ...
    protected void initialized() {
        ...
        mCatcher_num = getIntent().getStringExtra("catcher_num");
    }
