...
public class RockerView extends View {
    ...
    public RockerView(Context context, AttributeSet attrs) {
        ...
        if (isInEditMode()) {
            L.i(TAG, "RockerView: isInEditMode");
        }
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        ...
        L.i(TAG, "initAttribute: mAreaBackground = " + areaBackground + "   mRockerBackground = " + rockerBackground + "  mRockerRadius = " + mRockerRadius);
        typedArray.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        L.i(TAG, "onMeasure: --------------------------------------");
        L.i(TAG, "onMeasure: widthMeasureSpec = " + widthMeasureSpec + " heightMeasureSpec = " + heightMeasureSpec);
        L.i(TAG, "onMeasure: widthMode = " + widthMode + "  measureWidth = " + widthSize);
        L.i(TAG, "onMeasure: heightMode = " + heightMode + "  measureHeight = " + widthSize);
        L.i(TAG, "onMeasure: measureWidth = " + measureWidth + " measureHeight = " + measureHeight);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:// 移出区域
                ...
                L.i(TAG, "onTouchEvent: 抬起位置 : x = " + upX + " y = " + upY);
                break;
        }
        return true;
    }
    ...
    private Point getRockerPositionPoint(Point centerPoint, Point touchPoint, float regionRadius, float rockerRadius) {
        ...
        L.i(TAG, "getRockerPositionPoint: 角度 :" + angle + ", 距离：" + lenXY);
    ...
    private void moveRocker(float x, float y) {
        ...
        L.i(TAG, "onTouchEvent: 移动位置 : x = " + mRockerPosition.x + " y = " + mRockerPosition.y);
        invalidate();
    }
