...
public class CountdownView extends View {
    private BaseCountdowns mCountdown;
    ...
    public CountdownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCountdown = isHideTimeBackground ? new BaseCountdowns() : new BackgroundCountdowns();
    ...
    public void dynamicShow(DynamicConfig dynamicConfig) {
        ...
        if (!isHideTimeBackground && null != backgroundInfo) {
            ...
            if (null != isShowTimeBgBorder) {
                backgroundCountdowns.setIsShowTimeBgBorder(isShowTimeBgBorder);

                if (isShowTimeBgBorder) {
                    Integer borderColor = backgroundInfo.getBorderColor();
                    if (null != borderColor) {
                        backgroundCountdowns.setTimeBgBorderColor(borderColor);
                    }

                    Float borderSize = backgroundInfo.getBorderSize();
                    if (null != borderSize) {
                        backgroundCountdowns.setTimeBgBorderSize(borderSize);
                    }

                    Float borderRadius = backgroundInfo.getBorderRadius();
                    if (null != borderRadius) {
                        backgroundCountdowns.setTimeBgBorderRadius(borderRadius);
                    }
                }
                isReLayout = true;
            }
    ...
    public void setConvertDaysToHours(boolean val) {
        mCountdown.isConvertDaysToHours = val;
    }
}
